package com.example.a08_retrofit_ejerciciodisney.adapters;
...
import com.example.a08_retrofit_ejerciciodisney.R;
import com.example.a08_retrofit_ejerciciodisney.VerPersonajeActivity;
...
public class PersonajesAdapter extends RecyclerView.Adapter<PersonajesAdapter.PersonajeVH> {
    ...
    public class PersonajeVH extends RecyclerView.ViewHolder{
        ...
        public PersonajeVH(@NonNull View itemView) {
            ...
            lblNombre = itemView.findViewById(R.id.lbNombrePersonajeVH);
        }
    }
}
