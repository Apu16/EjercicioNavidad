package com.example.a08_retrofit_ejerciciodisney;
...
import com.example.a08_retrofit_ejerciciodisney.adapters.PersonajesAdapter;
import com.example.a08_retrofit_ejerciciodisney.conexiones.ApiConexiones;
import com.example.a08_retrofit_ejerciciodisney.conexiones.RetrofitObject;
        ...
        getNextPage.enqueue(new Callback<Respuesta>() {
            ...
            public void onResponse(Call<Respuesta> call, Response<Respuesta> response) {
                if (response.code() == HttpURLConnection.HTTP_OK) {
                    ...
                    Toast.makeText(MainActivity.this, "PÁGINA CARGADA", Toast.LENGTH_SHORT).show();
                }
            }
